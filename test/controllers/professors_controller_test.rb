...
class ProfessorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create professor" do
    assert_difference('Professor.count') do
      post professors_url, params: { professor: { fecha_nacimiento: @professor.fecha_nacimiento, nombre: @professor.nombre, rfc: @professor.rfc } }
    end
  ...
  test "should update professor" do
    patch professor_url(@professor), params: { professor: { fecha_nacimiento: @professor.fecha_nacimiento, nombre: @professor.nombre, rfc: @professor.rfc } }
